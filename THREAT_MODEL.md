...
| Oversized, redirected, or rebinding OSV responses | Fixed HTTPS origin, public-address validation and connection pinning, redirect rejection, bounded pagination, response-size and timeout limits | A valid but pathological record can still cause the Assessment to fail closed |
